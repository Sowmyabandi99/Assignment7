...
Original file is located at
    https://colab.research.google.com/drive/1OYx1lvpO_TMNLN0bNlmIl3tKRBaLrm7K
"""
...
ax.text(3,4,-5, "A", color='red')
ax.scatter(B[0],B[1],B[2],'o')
ax.text(-2,1,4, "B", color='red')
ax.scatter(M[0],M[1],M[2],'o')
ax.text(0.5,2.5,-0.5, "M", color='red')
